...
## 현재 작업
- 블로그 글 300개 생성 진행 중 (현재 36개 완료: batch-01 10개 + batch-02 16개 + batch-03 10개)
- batch-03 10개 글 생성·검증 완료, 커밋/푸시 준비 중

## 최근 변경 (최근 5개)
- 05-16: batch-03.ts 생성 (10개 글, 각 3출처·90점 이상·본문 3500자 이상) — 총 36개
...
- [ ] batch-04 ~ batch-10 순차 생성 (목표: 총 300개, 현재 36개)
  - 다음 주제: 인천·대구·광주 창업, 제조창업, 프랜차이즈 창업, 온라인 쇼핑몰, 청년 정책자금, 창업자 대출 등
