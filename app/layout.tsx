...
export const metadata: Metadata = {
  ...
  description: "공공지원사업, 지원사업 공고, 마감 임박 공고를 한 곳에서 빠르게 확인하고 신청 조건을 정리해 줍니다.",
  alternates: {
    canonical: "/"
  },
  openGraph: {
    title: `${siteName} | 창업지원사업 공고 모음`,
    description: "공고 정보를 빠르게 정리해 검색과 신청 흐름에 맞는 페이지로 이동할 수 있게 구성했습니다.",
    images: [
      {
        url: "/og-default.svg",
        width: 1200,
  ...
  twitter: {
    ...
    title: "창업지원사업 공고 모음",
    description: "지원사업·정책자금 공고와 마감일 정보를 빠르게 확인할 수 있는 채널입니다.",
