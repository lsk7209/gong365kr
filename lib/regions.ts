...
export const regionRows = [
  ...
  { code: "incheon", name: "인천", group: "수도권", keywords: ["인천", "인천광역시"] },
  { code: "busan", name: "부산", group: "영남권", keywords: ["부산", "부산광역시"] },
  { code: "daegu", name: "대구", group: "영남권", keywords: ["대구", "대구광역시"] },
  { code: "ulsan", name: "울산", group: "영남권", keywords: ["울산", "울산광역시"] },
  ...
  { code: "sejong", name: "세종", group: "충청권", keywords: ["세종", "세종특별자치시"] },
  { code: "chungbuk", name: "충북", group: "충청권", keywords: ["충북", "충청북도"] },
  { code: "chungnam", name: "충남", group: "충청권", keywords: ["충남", "충청남도"] },
  { code: "gwangju", name: "광주", group: "호남권", keywords: ["광주", "광주광역시"] },
  { code: "jeonbuk", name: "전북", group: "호남권", keywords: ["전북", "전라북도", "전북특별자치도"] },
  { code: "jeonnam", name: "전남", group: "호남권", keywords: ["전남", "전라남도"] },
